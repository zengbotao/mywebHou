...
//        Book user = new Book();
//        user.setId(book.getId());
//        user.setScan(book.getScan());
//        user.setDescription(book.getDescription());
//        user.setTitle(book.getTitle());
//        user.setLabel(book.getLabel());
//        user.setText(book.getText());
